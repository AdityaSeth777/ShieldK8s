  ...
  return (
    <div className="relative flex items-center space-x-2">
      ...
      <select
        ...
        className="w-full px-4 py-2 bg-black bg-opacity-80 border border-cyber-blue/20 rounded-lg text-white appearance-none cursor-pointer focus:outline-none focus:border-cyber-blue/50 backdrop-blur-sm"
      >
